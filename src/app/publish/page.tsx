  ...
  return (
    <div className="min-h-screen py-20">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <div className="glass-dark rounded-2xl p-8 max-w-4xl mx-auto">
            <div className="text-center mb-8">
              <h2 className="text-3xl font-bold text-white mb-4">Revenue Sharing</h2>
              <p className="text-white/70">Earn 70% of revenue from your agent usage</p>
            </div>
            <div className="grid md:grid-cols-3 gap-6">
              <div className="text-center">
                <div className="text-4xl font-bold text-emerald-400 mb-2">70%</div>
                <div className="text-white/70">You Earn</div>
              </div>
              <div className="text-center">
        ...
        {/* Publishing Steps */}
        <div className="mb-16">
          <h2 className="text-3xl font-bold text-white text-center mb-12">How to Publish</h2>
        ...
        >
          <div className="glass-dark rounded-2xl p-8">
            <h2 className="text-2xl font-bold text-white mb-6">Agent Requirements</h2>
        ...
        >
          <div className="glass-dark rounded-2xl p-8 max-w-2xl mx-auto">
            <h2 className="text-2xl font-bold text-white mb-4">Ready to Publish?</h2>
            <p className="text-white/70 mb-6">Start building and publishing your AI agents today</p>
